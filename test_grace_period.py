#!/usr/bin/env python3
"""
Test Grace Period Information
Checks if grace period information exists in the document
"""

import requests
import time

def test_grace_period_only():
    """Test only the grace period question"""
    ...
    print(f"🎯 Testing Grace Period Question Only")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if answers:
                ...
                if 'thirty days' in answer_lower or '30 days' in answer_lower:
                    print(f"✅ SUCCESS: Found grace period information!")
                else:
                    print(f"❌ FAILED: No grace period information found")
                    print(f"💡 The document might not contain grace period information or it's not being extracted properly")
        ...
        print(f"❌ Error testing grace period: {e}")

if __name__ == "__main__":
    test_grace_period_only() 