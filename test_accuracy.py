#!/usr/bin/env python3
"""
Test improved accuracy with a simple question
"""
import time
import requests
import json

def test_accuracy_with_real_document():
    """Test the API accuracy with a real policy document"""
    ...
    # Test with a real policy document URL (you can replace this with your actual document)
    payload = {
    ...
    print("🎯 Testing API accuracy with optimized prompts...")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"\n📊 Accuracy Score: {found_count}/{len(accuracy_indicators)} ({found_count/len(accuracy_indicators)*100:.1f}%)")
...
if __name__ == "__main__":
    test_accuracy_with_real_document() 